...
public class DatabaseService : IDatabaseService
{
    ...
    // Add GetBookingsMissingHotelRooms() and will return all bookings that do not have associated hotel rooms
    [KernelFunction]
    ...
    // Add GetBookingsWithMultipleHotelRooms() and will return all bookings with more than one hotel room
    [KernelFunction]
